...
1. `ghcr.io/iamvikshan/devcontainers/bun:latest` ~ 133.08 MiB
2. `registry.gitlab.com/vikshan/devcontainers/bun:latest` ~ 133.08 MiB
3. `docker.io/vikshan/bun:latest` ~ 133.08 MiB
