...
1. `ghcr.io/iamvikshan/devcontainers/bun-node:latest` ~ 226.39 MiB
2. `registry.gitlab.com/vikshan/devcontainers/bun-node:latest` ~ 226.39 MiB
3. `docker.io/vikshan/bun-node:latest` ~ 226.39 MiB
